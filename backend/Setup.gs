...
function createManualSheet() {
  ...
  var data = [
    ...
    // --- SETTINGS ---
    ["Settings (Налаштування)", "key", "Текст", "Унікальний ключ конфігураційного параметра системи.", "dwell_seconds / points_version"],
    ["Settings (Налаштування)", "value", "Текст / Число", "Значення конфігураційного параметра.", "60 / 15000 / true"],
