...
function createManualSheet() {
  ...
  var data = [
    ...
    ["Settings (Налаштування)", "idle_threshold_minutes", "Хвилини", "Мінімальний час перебування на одному місці для реєстрації зупинки (idle/stop) в системі.", "10"],
    ["Settings (Налаштування)", "idle_radius_m", "Метри", "Максимальний радіус дрейфу GPS (дрифту координат) на одному місці для визначення стану спокою/зупинки.", "20"],
