...
function sendSetupInstructions(chatId) {
  var text = "📱 <b>Інструкція з налаштування геопозиції:</b>\n\n" +
             "🍏 <b>Для iPhone (iOS):</b>\n" +
             "1️⃣ Відкрийте <b>Параметри</b> (Settings) на iPhone ⚙️\n" +
             "2️⃣ Прокрутіть униз до списку програм і виберіть <b>Telegram</b>\n" +
             "3️⃣ Перейдіть у пункт <b>«Геопозиція»</b> (Location)\n" +
             "4️⃣ Оберіть <b>«Завжди»</b> (Always) — <i>(а не «Під час використання»)</i>\n" +
             "5️⃣ Переконайтеся, що увімкнено <b>«Точна геопозиція»</b> (Precise Location)\n\n" +
             "🤖 <b>Для Android:</b>\n" +
             "1️⃣ Налаштування ➡️ Програми ➡️ <b>Telegram</b>\n" +
             "2️⃣ Дозволи ➡️ Місцезнаходження ➡️ <b>«Дозволити у будь-якому режимі»</b> (Allow all the time)\n" +
             "3️⃣ Увімкніть <b>«Точне місцезнаходження»</b>\n\n" +
             "⚠️ <i>Це потрібно для того, щоб передача геопозиції не переривалася, коли екран телефону вимкнено або закрито додаток.</i>";
...
function startShiftCommand(chatId) {
  try {
    ...
    var text = "🟢 <b>Зміну розпочато!</b>\n\nТепер натисніть на <b>Скріпку (📎)</b> ➡️ <b>«Геопозиція»</b> ➡️ <b>«Транслювати мою геопозицію» (Live Location)</b> на 8 годин.";
    sendTelegramRequest("sendMessage", {
      "chat_id": chatId,
      "text": text,
      "parse_mode": "HTML",
